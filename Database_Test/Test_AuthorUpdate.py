...
class MyTest(unittest.TestCase):
    ...
    def test_database(self):
        ...
        self.assertNotEqual(before_name,after_name, "Test fail new author wasn't updated")
        self.assertNotEqual(before_pass,after_pass,"Test fail new author wasn't updated")
