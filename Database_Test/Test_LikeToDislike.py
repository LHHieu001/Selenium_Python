...
class MyTest(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.driver.get("http://localhost/blog_git/personalBlog/user_likes.php")
    ...
    def test_login(self):
        ...
        if value:
            ...
            self.assertIsNone(result_1, "Test Failed: Like found for the given post_id and user_id.")
            self.assertIsNotNone(result_2, "Test Failed: DisLike is not found for the given post_id and user_id.")
        else:
