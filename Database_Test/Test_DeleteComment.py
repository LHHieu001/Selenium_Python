...
class MyTest(unittest.TestCase):
    ...
    def test_database(self):
        ...
        decomment = self.driver.find_element(By.NAME, "delete_comment")
        self.driver.execute_script("arguments[0].click();", decomment)
        ...
        if value:
            ...
            self.assertIsNone(result, "Test Failed: Comment found for the given post_id and user_id.")
        else:
